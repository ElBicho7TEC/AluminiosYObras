     	    ...
     	    <div class="clear"></div>
			    ...
			    <div class="box1" ">
				          <div class="register_account " style="border: solid; background-color: white; padding: 40px 50px; border-radius: 5px; width: 40%; margin-left: auto; margin-right: auto; color: black; font-weight: bold !important" >
				            <div>
				                <center><h4 style="color: black;">Agregar Galeria</h4></center>
				            </div>
		
				            <form action="btnCrear_Auditor" method="post" enctype="multipart/form-data" style="color: black; ">
						            <div class="row">
								        <div class="col-2">
		                                <b><label>Nombre Proyecto</label></b>
		                            	</div>
		                            	<div class="col-5">    
		                                <input type="text" class="form-control"  name="nombremodulo" id="nombremodulo" required style="width: auto; border: solid; " >
		                            	</div>
						            </div>
						            <div class="row">
								        <div class="col-3">
						              ...
						              <div class="row">
						               ...
						               <div class="row">
								        <div class="col-3">
		                                <b><label>Descripción larga</label></b>
		                            	</div>
		                            	<div class="col-5">    
		                                <textarea class="form-control" id="descripcionlarga" name="descripcionlarga" rows="3" style="width: auto; order: solid;"></textarea>
		                            	</div>
						              </div>
