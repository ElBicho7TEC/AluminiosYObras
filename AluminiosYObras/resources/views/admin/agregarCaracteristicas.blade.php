     	    ...
     	    <div class="clear"></div>
			    ...
			    <div class="box1" ">
				          <div class="register_account " style="border: solid; background-color: white; padding: 40px 50px; border-radius: 5px; width: 40%; margin-left: auto; margin-right: auto; color: black; font-weight: bold !important" >
				            <div>
				                <center><h4 style="color: black;">Agregar caracteristicas de modulo</h4></center>
				            </div>
				            ...
				            <form action="btnCrear_Auditor" method="post" enctype="multipart/form-data" style="color: black; ">
						            <div class="row">
		                            	...
		                            	<div class="col-5">    
		                                <input type="text" class="form-control" readonly="true" name="nombremodulo" id="nombremodulo" required style="width: auto; border: solid; " >
		                            	</div>
						            </div>
						            <div class="row">
								        <div class="col-3">
		                                <b><label>Caracteristicas</label></b>
		                            	</div>
		                            	<div class="col-5">    
		                               			<input type="text" class="form-control"  name="carateristicas" id="caracteristicas" required style="width: auto; border: solid; " >
		                            	</div>
						            </div>
						              ...
						              <div class="row">
								        <div class="col-3">
		                                <b><label>Modulo</label></b>
		                            	</div>
		                            	<div class="col-5">    
		                                <input type="text" class="form-control"  name="fkmodulo" required style="width: auto; border: solid;">
		                            	</div>
						            </div>
