     	    ...
     	    <div class="clear"></div>
			    ...
			    <div class="box1" ">
				          <div class="col-12" style="font-size:35px; font-weight: bold;  font-style:italic;" >
    						 <center> <label>Caracteristicas</label> </center>
    					  </div>
										  ...
										  <thead class="thead-dark" style="color: black">
										    <tr>
											  ...
											  <tbody>
											    ...
											    <tr style="text-align:center;">
											      <th scope="row" style="color: black"><i class="mdi mdi-pencil-box"></i>2 <i class="mdi mdi-file-excel-box" ></i></th>
											      <td>Caracteristica 2</td>
											      <td>Puertas</td>
											    </tr>
											    <tr style="text-align:center;">
											      <th scope="row" style="color: black"><i class="mdi mdi-pencil-box"></i>3 <i class="mdi mdi-file-excel-box" ></i></th>
											    ...
											    <tr style="text-align:center;">
											      <th scope="row"><i class="mdi mdi-pencil-box" ></i>7 <i class="mdi mdi-file-excel-box" ></i></th>
											       <td>Caracteristica 3</td>
											      <td>Ventas</td>
