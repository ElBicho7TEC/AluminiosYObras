                  		...
                  		Ver foto galeria de los proyectos
							...
							<div class="table-responsive">
								  ...
								  <div class="container-login100-form-btn">
								  		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                					    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button class="login100-form-btn" style="background-color: black;" data-toggle="modal" data-target="#agregarproyectoFotoGaleria">
                    					Agregar foto
                  						</button>
                				</div>
						</form>
...
<!--===============================================================================================-->
  ...
  <!--=======================Modal editar ===============================-->
<div class="modal fade" id="editarproyectoFotoGaleria" ">
  <div class="cont span_2_of_3">
                ...
                <button type="button" style="color: white" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
          		...
          		<div class="container-login100" >
            		<div class="wrap-login100">
                		...
                		<br>
                		<span class="login100-form-title-1" style="color: black !important;">
                  		Editar Foto Galeria Del Proyecto
                		</span>
              			</div>
              			<form class="login100-form validate-form" method="post" action="btnEditarProyecto" enctype="multipart/form-data">
				            	 {{csrf_field()}}
                				    ...
                				    <div class="wrap-input100 validate-input m-b-26" data-validate="Descripción breve del proyecto requerido">
		                            	...
		                            	<textarea class="input100" type="text" name="descripcionbreve" placeholder="Ingresar la descripción para la foto del proyecto" value="" rows="3"> </textarea>
                 						<span class="focus-input100"></span>
                					</div>
                					 <div class="wrap-input100 validate-input m-b-26" data-validate="Nombre del modulo requerido">
                                  	...
                                  	<input class="input100" type="text" name="nombreproyecto" placeholder="Ingresar el proyecto para la foto" value="">
                          			  <span class="focus-input100"></span>
                          			</div>
