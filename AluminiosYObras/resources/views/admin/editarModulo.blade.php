											    ...
											    <tr style="text-align:center;">
											      <th scope="row" style="color: black">
											      	 <div class="col-md-9" style="padding: 3px;">
													    <button style="text-align:center;" class="btn-floating btn-small waves-effect waves-light blue" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="../../storage/images/icons/iconoeditar.png" width="20" height="20"></button>
													  </div>
