    ...
    <div class="cont span_2_of_3">
      <div class="mens-toolbar" align="center">
          ...
          <div class="limiter">
              ...
              @endif
                    <form class="login100-form validate-form" method="post" action="../btnEditarBanner" enctype="multipart/form-data">
                       {{csrf_field()}}
                          ...
                          <div class="flex-sb-m w-full p-b-30">
                            <div>
                              <br>
                              <a href="#" class="txt1">
                                Para editar cualquier banner favor de seleccionar un archivo y dar click en guardar cambios
                                <br>
