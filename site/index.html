    ...
    <div class="page">
      <section class="section section-relative section-header" id="home">
              ...
              <div class="rd-navbar-main-outer">
                <div class="rd-navbar-main">
                  ...
                  <div class="rd-navbar-panel">
                    ...
                    <!-- RD Navbar Brand-->
                    <div class="rd-navbar-brand"><a class="brand" href="index.html"><img class="brand-logo-dark" src="images/logo-default-119x102.png" alt="" width="119" height="102"/><img class="brand-logo-light" src="images/logo-inverse-119x102.png" alt="" width="119" height="102"/></a>
                    </div>
                  </div>
        ...
        <section class="section context-dark section-jumbotron bg-cover" style="background: url(images/bg-image.jpg) #151515">
          <div class="panel-left"><a class="brand" href="index.html"><img class="brand-logo-dark" src="images/logo-default-119x102.png" alt="" width="119" height="102"/><img class="brand-logo-light" src="images/logo-inverse-119x102.png" alt="" width="119" height="102"/></a>
