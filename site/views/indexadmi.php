              ...
              <div class="rd-navbar-main-outer">
                <div class="rd-navbar-main">
                  ...
                  <div class="rd-navbar-panel">
                    ...
                    <!-- RD Navbar Brand-->
                    <div class="rd-navbar-brand"><a class="brand" href="views/index.php"><img class="brand-logo-dark" src="../images/logo-default-119x102.png" alt="" width="119" height="102"/><img class="brand-logo-light" src="../images/logo-inverse-119x102.png" alt="" width="119" height="102"/></a>
                    </div>
                  </div>
